...
function createDynamoDbClient(regionName) {
  ...
  AWS.config.update({region: 'localhost', endpoint: 'http://localhost:8000', accessKeyId: 'k5gf2o', secretAccessKey: 'asfxb7'});
  return new AWS.DynamoDB();
}

function createPutItemInput(email, firstName, lastName) {
return {
  "TableName": "User",
  "Item": {
    "Email": {
...
module.exports = { createDynamoDbClient, createPutItemInput, executePutItem }