    ...
    return (
        <Paper elevation={3} style={styles.postBox}>
            <div style={{ borderBox: "border-box", height: "87px", display: "flex" }}>
                ...
                <textarea style={styles.textarea} onChange={e => setComment(e.target.value)} value={comment} />
            </div>
            <div style={{borderBox: "box-sizing", padding: "0 12px 10px"}}>
                <Button onClick={handlePost} size="small" variant="contained" color="primary" style={{width: "100%"}}>
                    Post
                </Button>
            </div>
        </Paper>
